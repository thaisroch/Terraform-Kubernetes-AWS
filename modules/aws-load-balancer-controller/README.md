...
|------|-------------|------|---------|:--------:|
| <a name="input_eks_cluster_name"></a> [eks\_cluster\_name](#input\_eks\_cluster\_name) | EKS cluster name to be used to create helm load-balancer-controller | `string` | n/a | yes |
| <a name="input_eks_vpc_id"></a> [eks\_vpc\_id](#input\_eks\_vpc\_id) | VPC id to be used to create helm load-balancer-controller | `string` | n/a | yes |
